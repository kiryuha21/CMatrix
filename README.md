...
В данном проекте реализована библиотека matrix.h, которая содержит в себе функции для создания матриц и работы с ними. Также написаны unit-тесты для всех функций с помощью библиотеки <check.h>
